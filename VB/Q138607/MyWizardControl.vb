...
Namespace DXSample
	Public Class MyWizardControl
		...
		Protected Overrides Function SetSelectedPageCore(ByVal prevPage As BaseWizardPage, ByVal value As BaseWizardPage, ByVal direction As Direction) As Boolean
			Dim result As Boolean = MyBase.SetSelectedPageCore(prevPage, value, direction)
			UpdateLinksStatus()
			Return result
		End Function
	End Class
