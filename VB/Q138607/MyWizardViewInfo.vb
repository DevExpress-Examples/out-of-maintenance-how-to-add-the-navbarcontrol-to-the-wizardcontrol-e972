...
Namespace DXSample
	Public Class MyWizard97Model
		...
		Public Overrides Overloads Function GetInteriorPageBounds(ByVal page As BaseWizardPage) As Rectangle
			Return GetExteriorPageBounds(page)
		End Function
		Public Overrides Overloads Function GetInteriorHeaderBounds() As Rectangle
			Dim result As Rectangle = GetExteriorTitleBounds()
			result.X -= 10
			result.Width += 10
			Return result
		End Function
		Public Overrides Overloads Function GetInteriorHeaderImageBounds() As Rectangle
	...
	Public Class MyWizardViewInfo
		...
		Friend ReadOnly Property NavBarControl() As PanelControl
			...
			End Get
		End Property
		Protected Friend ReadOnly Property Owner() As WizardControl
			Get
				Return MyBase.WizardControl
			End Get
		End Property
